<?php /* Smarty version Smarty-3.1.19, created on 2017-02-20 00:17:55
         compiled from "/var/www/html/prestashop-1.6/prestashop/themes/default-bootstrap/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:210750901758aa35b32f5b85-28849211%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd1a2bd1ecec33360491ede8dcd127b0285f8c36' => 
    array (
      0 => '/var/www/html/prestashop-1.6/prestashop/themes/default-bootstrap/modules/blockcart/blockcart.tpl',
      1 => 1482157024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '210750901758aa35b32f5b85-28849211',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58aa35b36f9929_82947253',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58aa35b36f9929_82947253')) {function content_58aa35b36f9929_82947253($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/html/prestashop-1.6/prestashop/tools/smarty/plugins/modifier.replace.php';
...
<?php $_tmp27=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp25."&ipa=".$_tmp26."&id_address_delivery=".$_tmp27."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp29=ob_get_clean();?><?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['id_customization']->value);?>
<?php $_tmp30=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('cart',true,null,"delete=1&id_product=".$_tmp28."&ipa=".$_tmp29."&id_customization=".$_tmp30."&token=".((string)$_smarty_tpl->tpl_vars['static_token']->value)), ENT_QUOTES, 'UTF-8', true);?>
" rel="nofollow">&nbsp;</a>
													</div>
