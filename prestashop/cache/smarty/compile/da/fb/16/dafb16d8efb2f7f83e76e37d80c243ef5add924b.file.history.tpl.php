<?php /* Smarty version Smarty-3.1.19, created on 2017-02-20 00:17:59
         compiled from "/var/www/html/prestashop-1.6/prestashop/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:33963207958aa35b78edf23-81469546%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dafb16d8efb2f7f83e76e37d80c243ef5add924b' => 
    array (
      0 => '/var/www/html/prestashop-1.6/prestashop/themes/default-bootstrap/history.tpl',
      1 => 1482157024,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '33963207958aa35b78edf23-81469546',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58aa35b7994013_20422503',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58aa35b7994013_20422503')) {function content_58aa35b7994013_20422503($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/var/www/html/prestashop-1.6/prestashop/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp18=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-detail',true,null,"id_order=".$_tmp18), ENT_QUOTES, 'UTF-8', true);?>
');">
...
<?php $_tmp20=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp20), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp21=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp21), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
